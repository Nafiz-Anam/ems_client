...
const KycDetails = () => {
    ...
    console.log(image2);
    const [updateKycDetails] = useUpdateKycDetailsMutation();
    ...
    useEffect(() => {
        if (details) {
            setContactDetails({ ...details.kyc_details });
            setImage(details?.kyc_details?.id_img1);
            setImage2(details?.kyc_details?.id_img2);
        }
    }, [details]);
    ...
    const handleFormSubmit = async (e) => {
        ...
        Object.keys(contactDetails).forEach((key) => {
            if (key !== "id_img1" && key !== "id_img2") {
                formData.append(key, contactDetails[key]);
            }
        });
        formData.append("id_img1", image);
        formData.append("id_img2", image2);
        formData.append("employee_id", id);
        await updateKycDetails(formData);
    };
                    ...
                    <>
                        <section className="my-8">
                            ...
                            >
                                ...
                                <div className="col-span-12 md:col-span-12">
                                    <div className="">
                                        <p className="mb-1">ID front image</p>
                                        <ImageUploader
                                            onImageChange={(newImage) =>
                                                setImage(newImage)
                                            }
                                            initialImage={
                                                details?.kyc_details?.id_img1 ||
                                                image
                                            }
                                        />
                                    </div>
                                ...
                                <div className="col-span-12 md:col-span-12">
                                    <div className="">
                                        <p className="mb-1">ID Back Image</p>
                                        <ImageUploader
                                            onImageChange={(newImage) =>
                                                setImage2(newImage)
                                            }
                                            initialImage={
                                                details?.kyc_details?.id_img2 ||
                                                image2
                                            }
                                        />
                                    </div>
