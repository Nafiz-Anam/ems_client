...
import { BankingModal } from '../Modals/modalComponents/PaymentGatewayModal';
...
const Banking = () => {
  ...
  const handleAddNewCard = () => {
    ...
    setModalContent(<BankingModal onConfirm={() => console.log("confirm")} />)
  };
  ...
  const tableHeader = [
    ...
    { id: 4, name: 'BCode', field: 'BCode' },
    { id: 5, name: 'swift Code', field: 'swift_Code' },
    { id: 3, name: 'Status', field: 'status' },
  ]
  const fieldToShow = ["logo", "methodName", "swift_Code", "BCode", "status"]
